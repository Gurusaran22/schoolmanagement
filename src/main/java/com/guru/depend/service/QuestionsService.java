...
public class QuestionsService {
	...
	public Questions createRecord(Questions questions ) {return questionsrepository.save(questions);}

    //to view all the data
	public List<Questions> allData() {return questionsrepository.findAll();}
   ...
   //tp view the question by the subject with the help of subject id 
    public List<QuestionDTO> getQuestionBySubject(Long id){return questionsrepository.findBysubject_id(id);}
